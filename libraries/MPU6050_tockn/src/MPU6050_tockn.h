...
#define MPU6050T_ADDR         0x68
#define MPU6050T_SMPLRT_DIV   0x19
#define MPU6050T_CONFIG       0x1a
#define MPU6050T_GYRO_CONFIG  0x1b
#define MPU6050T_ACCEL_CONFIG 0x1c
#define MPU6050T_WHO_AM_I     0x75
#define MPU6050T_PWR_MGMT_1   0x6b
#define MPU6050T_TEMP_H       0x41
#define MPU6050T_TEMP_L       0x42

class MPU6050T{
  public:

  MPU6050T(TwoWire &w);
  MPU6050T(TwoWire &w, float aC, float gC);

  void begin();

  void setGyroOffsets(float x, float y, float z);

  void writeMPU6050T(byte reg, byte data);
  byte readMPU6050T(byte reg);
