 ...
 */
TaskHandle_t BlinkThreadHandle;
...
void setup() {
   ...
   * Task creation
   */
  xTaskCreate(BlinkThread, // Task function
              "Blink", // Task name
              128, // Stack size 
              NULL, 
              0, // Priority
              &BlinkThreadHandle); // Task handler
...
void TaskSerial(void *pvParameters)
{
  ...
  for (;;)
  {
    ...
    Serial.print("- TASK ");
    Serial.print(pcTaskGetName(BlinkThreadHandle)); // Get task name with handler
    Serial.print(", High Watermark: ");
    Serial.print(uxTaskGetStackHighWaterMark(BlinkThreadHandle));
    Serial.println();
