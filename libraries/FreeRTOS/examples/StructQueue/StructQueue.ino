...
void setup() {
  ...
  if (structQueue != NULL) {
    ...
    xTaskCreate(LoggerThreadPin0, // Task function
    ...
    xTaskCreate(LoggerThreadPin1, // Task function
 ...
 */
void LoggerThreadPin0(void *pvParameters)
{
  (void) pvParameters;
 ...
 * See Blink_AnalogRead example.
 */
void LoggerThreadPin1(void *pvParameters)
{
  (void) pvParameters;
